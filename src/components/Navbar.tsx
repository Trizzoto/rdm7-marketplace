      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-[68px]">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden sm:flex items-center gap-6">
            ...
            <a href="https://studio.realtimedatamonitoring.com.au" target="_blank" rel="noopener noreferrer" className="font-heading text-sm font-bold uppercase tracking-wider text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors flex items-center gap-1">
              RDM Studio
